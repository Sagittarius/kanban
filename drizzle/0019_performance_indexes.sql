...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `task_activity_board_created_idx` ON `task_activity` (`board_id`, `created_at`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `audit_logs_actor_created_idx` ON `audit_logs` (`actor_user_id`, `created_at`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `audit_logs_board_created_idx` ON `audit_logs` (`board_id`, `created_at`);
