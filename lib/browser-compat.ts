export const browserCompatPolicy = {
  baselineLabel: "Chrome 87+ / Edge 87+ / Firefox 78+ / Safari 14+",
...
export function getBrowserCompatIssue(
  ...
  if (firefox !== null) {
    return (
      versionIssue("Firefox", firefox, 78, "firefox-version-too-low", "unsupported", "最低支持版本") ??
      (includeRecommended
  ...
  if (safari !== null && !/(?:Chrome|Chromium|CriOS|FxiOS|Edg|OPR)\//i.test(ua)) {
    return (
      versionIssue("Safari", safari, 14, "safari-version-too-low", "unsupported", "最低支持版本") ??
      (includeRecommended
...
export function buildBrowserCompatGateScript() {
  ...
  return `(function(){` +
    ...
    `function browserIssue(ua){` +
      ...
      `if(firefox!==null){return versionIssue("Firefox",firefox,78,"firefox-version-too-low","unsupported","最低支持版本")||versionIssue("Firefox",firefox,115,"firefox-version-recommended","recommended","推荐版本");}` +
      ...
      `if(safari!==null&&!/(?:Chrome|Chromium|CriOS|FxiOS|Edg|OPR)\\//i.test(ua)){return versionIssue("Safari",safari,14,"safari-version-too-low","unsupported","最低支持版本")||versionIssue("Safari",safari,16,"safari-version-recommended","recommended","推荐版本",4);}` +
      `return null;` +
    `}` +
